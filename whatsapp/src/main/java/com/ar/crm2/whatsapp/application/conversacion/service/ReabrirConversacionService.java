...
import com.ar.crm2.whatsapp.application.conversacion.port.in.ReabrirConversacionUseCase;
...
public class ReabrirConversacionService implements ReabrirConversacionUseCase {

    private final FindConversacionByIdPort findPort;
    private final SaveConversacionPort savePort;

    @Override
    public Conversacion reabrir(UUID conversacionId) {
        ...
        return savePort.save(conversacion.cambiarEstado(EstadoConversacion.ABIERTA));
    }
}

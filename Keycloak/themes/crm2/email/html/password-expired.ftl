          ...
          <tr>
            <td style="background:#ffffff;border:1px solid #d9e2ec;border-radius:11px;overflow:hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 36px 32px;">
                <tr>
                  <td>
                    <h2 style="font-size:18px;font-weight:700;color:#1e293b;margin-bottom:16px;">Tu contraseña ha expirado</h2>
                    <#if user.firstName??>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:24px;">
                      <tr>
                        <td align="center">
                          <a href="${link}" class="button" style="background:#1e293b;color:#ffffff;padding:14px 32px;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;display:inline-block;">Crear nueva contraseña</a>
                        </td>
                      </tr>
                    </table>
                    <!-- Link fallback -->

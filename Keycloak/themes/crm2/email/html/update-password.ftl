<#--
  CRM2 Email Template — Actualizar contraseña
...
<head>
  ...
  <title>Actualiza tu contraseña — CRM2</title>
  <!--[if mso]>
  <style type="text/css">
          ...
          <tr>
            <td style="background:#ffffff;border:1px solid #d9e2ec;border-radius:11px;overflow:hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 36px 32px;">
                <tr>
                  <td>
                    <h2 style="font-size:18px;font-weight:700;color:#1e293b;margin-bottom:16px;">Actualizá tu contraseña</h2>
                    <#if user.firstName??>
                    ...
                    <p style="font-size:15px;color:#475569;line-height:1.6;margin-bottom:20px;">
                      Se te solicita actualizar la contraseña de tu cuenta CRM2 en <strong>${realmName}</strong>.
                    </p>
                    <!-- CTA Button -->

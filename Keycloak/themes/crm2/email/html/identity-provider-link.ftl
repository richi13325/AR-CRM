<#--
  CRM2 Email Template — Enlace de proveedor de identidad
...
<head>
  ...
  <title>Vincular cuenta — CRM2</title>
  <!--[if mso]>
  <style type="text/css">
                  ...
                  <td>
                    ...
                    <#if identityProviderAlias??>
                      <p style="font-size:15px;color:#475569;line-height:1.6;margin-bottom:20px;">
                        Se solicita vincular tu cuenta CRM2 con el proveedor de identidad: <strong>${identityProviderAlias}</strong>.
                      </p>
                    </#if>
                    <!-- CTA Button -->

<#--
  CRM2 Email Template — Restablecer contraseña (Olvidé mi contraseña)
...
<head>
  ...
  <title>Restablecer contraseña — CRM2</title>
  <!--[if mso]>
  <style type="text/css">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 36px 32px;">
                <tr>
                  <td>
                    ...
                    <p style="font-size:12px;color:#94a3b8;line-height:1.5;">Si no solicitaste este cambio, podés ignorar este mensaje. Tu contraseña seguirá siendo la misma.</p>
                  </td>
                </tr>
              </table>
              <!-- Footer -->

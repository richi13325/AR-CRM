<#--
  Pipely Email Template — Restablecer contraseña (Olvidé mi contraseña)
...
<head>
  ...
  <title>Restablecer contraseña — Pipely</title>
  <!--[if mso]>
  <style type="text/css">
          ...
          <tr>
            <td style="background:#ffffff;border:1px solid #d9e2ec;border-radius:11px;overflow:hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 36px 32px;">
                <tr>
                  <td>
                    <h2 style="font-size:18px;font-weight:700;color:#1e293b;margin-bottom:16px;">¿Olvidaste tu contraseña?</h2>
                    <#if user.firstName??>
                    ...
                    <p style="font-size:15px;color:#475569;line-height:1.6;margin-bottom:20px;">
                      Se solicitó un restablecimiento de contraseña para tu cuenta en <strong>${realmName}</strong>.
                    </p>
                    <!-- CTA Button -->
                    <table cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:24px;">
                      <tr>
                        <td align="center">
                          <a href="${link}" class="button" style="background:#1e293b;color:#ffffff;padding:14px 32px;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;display:inline-block;">Restablecer contraseña</a>
                        </td>
                      </tr>
                    </table>
                    <!-- Link fallback -->
                    ...
                    <#if linkExpiration??>
                      <p style="font-size:12px;color:#94a3b8;margin-bottom:8px;">Este enlace expira en ${linkExpiration}.</p>
                    </#if>
                    <p style="font-size:12px;color:#94a3b8;line-height:1.5;">Si no solicitaste este cambio, puedes ignorar este mensaje. Tu contraseña seguirá siendo la misma.</p>
                  </td>
                </tr>
              </table>
              <!-- Footer -->
